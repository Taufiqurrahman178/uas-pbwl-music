...
<div class="my-4 mx-5">
    ...
    <form method="POST" action="/track/tambah">
        @csrf
        ...
        <div class="form-group mt-4">
            ...
            <input type="text" class="form-control" id="namaTrack" name="track_name" placeholder="Masukkan nama Track">
        </div>
        <div class="form-group mt-4">
            <label for="namaWaktu">Waktu</label>
            <input type="number" class="form-control" id="namaWaktu" name="time" min="0" value="0" step="0.1" placeholder="Masukkan Waktu">
        </div>
        <input type="submit" class="btn btn-primary mt-4" value="Tambah Track" />
    </form>
